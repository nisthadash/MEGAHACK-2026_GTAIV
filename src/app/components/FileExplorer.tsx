    ...
    <div className="h-full bg-[#111827] flex flex-col">
      ...
      <div className="p-3 border-b border-[#1f2937]">
        <div className="flex items-center justify-between mb-3">
          ...
          <button className="w-6 h-6 rounded hover:bg-[#1f2937] flex items-center justify-center transition-colors cursor-pointer">
...
function FileTreeNode({ node, depth }: FileTreeNodeProps) {
    ...
    return (
      <div>
        <motion.div
          ...
          className="flex items-center gap-1 px-2 py-1 rounded w-full cursor-pointer select-none"
  ...
  return (
    <motion.div
      whileHover={{ backgroundColor: "#1f2937" }}
      className="flex items-center gap-2 px-2 py-1 rounded w-full cursor-pointer select-none"
