import svgPaths from "./svg-pwkn6tbatj";
...
function Password() {
  return (
    <div className="content-stretch flex items-center px-[16px] py-[14px] relative rounded-[12px] shrink-0 w-[400px]" data-name="Password">
      <div aria-hidden="true" className="absolute border border-solid border-white inset-0 pointer-events-none rounded-[12px]" />
      <p className="font-['Noto_Sans:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[20px] text-white whitespace-nowrap" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}>
        Password
      </p>
...
function Login() {
  return (
    <div className="content-stretch flex items-center justify-center px-[10px] py-[14px] relative rounded-[12px] shrink-0 w-[400px]" data-darkreader-inline-bgimage data-name="Login" style={{ backgroundImage: "linear-gradient(94.117deg, rgb(46, 76, 238) 9.9097%, rgb(34, 30, 191) 53.286%, rgb(4, 15, 117) 91.559%)", "--darkreader-inline-bgimage": "linear-gradient(94.117deg, var(--darkreader-background-2e4cee, #0e27ad) 9.9097%, var(--darkreader-background-221ebf, #1c199e) 53.286%, var(--darkreader-background-040f75, #040f77) 91.559%)" } as React.CSSProperties}>
...
function Frame4() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[53px] items-center left-[40px] top-[97px]">
      <Frame3 />
      <Frame8 />
    </div>
  );
...
export default function Signup() {
  return (
    <div className="bg-[#0f0f0f] relative size-full" data-name="Signup">
      ...
      <div className="absolute left-[795px] size-[302px] top-[60px]">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 302 302">
          <circle cx="151" cy="151" fill="url(#paint0_linear_6_186)" id="Ellipse 1" r="151" />
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_6_186" x1="151" x2="151" y1="0" y2="302">
      ...
      <div className="absolute flex items-center justify-center left-[1149px] size-[298.315px] top-[698px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "22" } as React.CSSProperties}>
        <div className="flex-none rotate-[-28.5deg]">
          <div className="relative size-[220px]">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 220 220">
              <circle cx="110" cy="110" fill="url(#paint0_linear_6_184)" id="Ellipse 2" r="110" />
              <defs>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_6_184" x1="110" x2="110" y1="0" y2="220">
      ...
      <div className="absolute h-0 left-[316px] top-[550px] w-[575px]">
        <div className="absolute inset-[-2px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 575 2">
            <line id="Line 3" stroke="var(--stroke-0, #4D4D4D)" strokeDasharray="12 12" strokeLinecap="round" strokeWidth="2" x1="1" x2="574" y1="1" y2="1" />
          </svg>
        </div>
      </div>
    </div>
